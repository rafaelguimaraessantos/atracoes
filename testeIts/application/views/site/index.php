...
// Use um loop para percorrer os resultados e exibi-los
while ($row = $result->fetch_assoc()) {
    echo "Nome da atração: " . $row["nome_atracao"] . "<br>";
    echo "Data: " . $row["data"] . "<br>";
    echo "Descrição: " . $row["descricao"] . "<br>";
    
    // Exibe a imagem a partir dos dados binários da coluna "flyer"
    echo '<img src="data:image/jpeg;base64,' . base64_encode($row["flyer"]) . '" alt="Flyer da atração"><br>';
